...
def wu(x_start, y_start, x_end, y_end, color):
    ...
    def get_endpoint(x_s, y_s):
        ...
        dots.extend([[*p(px, py), color + (255 * dens2, 255 * dens2, 255 * dens2)]])
        dots.extend([[*p(px, py), color + (255 * dens1, 255 * dens1, 255 * dens1)]])
    ...
    for x in range(x_s, x_e):
        ...
        dots.extend([[*p(x, y), color + (255 * dens2, 255 * dens2, 255 * dens2)]])
        dots.extend([[*p(x, y+1), color + (255 * dens1, 255 * dens1, 255 * dens1)]])
